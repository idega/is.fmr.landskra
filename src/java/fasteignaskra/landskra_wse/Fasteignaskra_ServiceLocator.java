/**
 * Fasteignaskra_ServiceLocator.java
 *
...
public class Fasteignaskra_ServiceLocator extends org.apache.axis.client.Service implements fasteignaskra.landskra_wse.Fasteignaskra_Service {

    public Fasteignaskra_ServiceLocator() {
    }


    public Fasteignaskra_ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Fasteignaskra_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
